...
const GermanC2Curriculum = () => {
 ...
 <div className="nestedGermanCurriculum" id="details">
      ...
      <div className="nestedGermanCurriculum-Content">
        ...
        <p>
          <li>
            In the C2 German courses in Bangalore you will understand
...
export default GermanC2Curriculum
