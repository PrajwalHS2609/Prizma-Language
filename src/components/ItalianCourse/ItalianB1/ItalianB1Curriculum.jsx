        ...
        <div className="nestedGermanCurriculum-Content">
          <p>
            <li>
              ...
              him/herself in Italian.{" "}
            </li>
            <li>
              {" "}
              <Image src={rightArrow} alt="" />
              It is the basic requirement for most of the Italy based
...
export default ItalianB1Curriculum
