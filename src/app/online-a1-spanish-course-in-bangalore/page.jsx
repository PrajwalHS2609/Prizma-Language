...
import SpanishA1Content from "../../components/SpanishCourse/SpanishA1/SpanishA1Content";
...
export const metadata = {
  title:
    "Online A1 Spanish Course in Bangalore | Online A1 Spanish Classes in Bangalore",
  description:
    "Online A1 Spanish Course in Bangalore from Certified Trainers, beginner-level to develop strong speaking, listening, reading, and writing skills.",
  canonical: "https://prizmaacademy.com/online-a1-spanish-course-in-bangalore",
  keywords: [],
};
